...
During my time studying how code an outline shader, I stumbled in many different tutorials solving the problem, btu every time I tried to reproduce those solution I couldn't make it through. So I decided to start from scratch trying to understand what shaders are and how to code one.
